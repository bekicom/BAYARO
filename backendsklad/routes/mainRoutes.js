...
import {
  ...
  listStoreReturns,
  rejectStoreReturn,
} from "../controllers/storeReturnController.js";
...
router.post("/products/store-returns/:id/approve", authMiddleware, approveStoreReturn);
router.post("/products/store-returns/:id/reject", authMiddleware, rejectStoreReturn);
